      ...
      e: for (var B = 0, G = C.length, bt = G >>> 1; B < bt; ) {
        ...
        if (0 > l(gl, z))
          yn < G && 0 > l(er, gl)
            ? ((C[B] = er), (C[yn] = z), (B = yn))
            : ((C[B] = gl), (C[hn] = z), (B = hn));
        else if (yn < G && 0 > l(er, z)) (C[B] = er), (C[yn] = z), (B = yn);
        else break e;
      }
    }
    return P;
...
function Hs(e) {
  if (e.propertyName === "value" && rl(jt)) {
    var n = [];
    As(n, jt, e, Gu(e)), ks(Mf, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (li(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", Hs))
    : e === "focusout" && li();
}
function If(e) {
  ...
  function S(f, a, d, h) {
    ...
    if (x === null) {
      for (; !T.done; N++, T = d.next())
        (T = m(f, T.value, h)),
          T !== null &&
            ((a = u(T, a, N)), _ === null ? (E = T) : (_.sibling = T), (_ = T));
      return j && gn(f, N), E;
    }
...
function go(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? ld : ud),
    (e = t(r, l)),
    Pt)
  ) {
    u = 0;
...
function Ca(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = zs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Cu(e, n, t, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = _e(u))
    : ((u = de(n) ? xn : le.current), (l.context = qn(e, u))),
...
function fd(e, n, t) {
  ...
  switch ((oo(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Lu(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null
      );
    case 10:
...
function Aa(e) {
  ...
  n !== null && ((e.alternate = null), Aa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[yu], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
Ja = function (e, n, t) {
  ...
  else (ce = !1), j && n.flags & 1048576 && na(n, Hr, n.index);
...
function Ld(e, n, t, r, l) {
  ...
  var s = To(e, 0, !1, null, null, !1, !1, "", Hi);
  return (
...
ws = No;
Ss = Ln;
var Td = { usingClientEntryPoint: !1, Events: [Jt, Un, ul, ys, gs, No] },
  ht = {
...
function Dd() {
  return kt("div", {
    ...
    children: [
      W("div", {
        className: "perfume",
        children: W("span", { children: " Perfume" }),
      }),
      W("div", {
        className: "essence",
        children: W("h2", { children: " Gabrielle Essence Eau De Parfum" }),
      }),
      W("div", {
        className: "floral",
        children: W("p", {
      ...
      kt("div", {
        className: "label",
        children: [
          W("label", { className: "num1", children: " $149.99" }),
          W("label", { className: "num2", children: "$169.99" }),
        ],
      }),
      W("div", {
        className: "button",
        children: kt("button", {
          ...
          children: [
            W(Md, {}),
            W("span", { className: "cart", children: " Add to Cart" }),
          ],
        }),
      }),
    ],
...
const Fd = "/Product-Preview/assets/image-product-desktop-46292547.jpg",
  Id = "/Product-Preview/assets/image-product-mobile-1140e112.jpg";
function jd() {
  return kt("div", {
    className: "container",
    children: [
      kt("div", {
        className: "image",
        children: [
          W("img", { className: "img", src: Fd }),
          W("img", { className: "img2", src: Id }),
        ],
      }),
      W("div", { className: "Perfume", children: W(Dd, {}) }),
    ],
  });
}
function Ud() {
  return W("div", { className: "App", children: W(jd, {}) });
}
Ql.createRoot(document.getElementById("root")).render(
  W(Sc.StrictMode, { children: W(Ud, {}) })
);
